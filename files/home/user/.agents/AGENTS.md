...
- Some commands might show as being not authenticated.  This could be because the AI agent is running inside a sandbox.  Examples of these include: `acli jira`, `aclia-extras jira`, and `gh`.
